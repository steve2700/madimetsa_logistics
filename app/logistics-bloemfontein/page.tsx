...
const PROVINCE = 'Free State'
const BASE_URL = 'https://www.madimetsalogistics.co.za'
const PAGE_URL = `${BASE_URL}/logistics-bloemfontein`

export const metadata: Metadata = {
  title: `Freight & Logistics in Bloemfontein | Madimetsa Logistics`,
  description:
    `Freight transport, warehousing and fleet management serving Gqeberha (Port Elizabeth) and the wider Eastern Cape region, dispatched nationwide from Madimetsa Logistics. Call 072 308 9983.`,
  keywords: [
    'freight transport Bloemfontein',
    'logistics company Bloemfontein',
    'warehousing Free State',
    'fleet management Free State',
    'freight forwarding Bloemfontein',
    'express delivery Bloemfontein',
  ],
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: `Freight & Logistics in Bloemfontein | Madimetsa Logistics`,
    description: `Freight transport, warehousing and fleet management serving Gqeberha, dispatched nationwide. Call 072 308 9983.`,
    url: PAGE_URL,
    type: 'website',
...
const reasons = [
  {
    heading: 'Central Hub for the Interior',
    body: `${CITY}'s central location makes it a natural link between our Gauteng hubs and destinations further south, keeping freight to and from the Free State on a dependable timetable.`,
  },
  {
...
export default function BloemfonteinLogisticsPage() {
  return (
    <>
      <script
