...
const CITY = 'Centurion'
const PROVINCE = 'Gauteng'
const BASE_URL = 'https://www.madimetsalogistics.co.za'
const PAGE_URL = `${BASE_URL}/logistics-centurion`

export const metadata: Metadata = {
  title: `Freight & Logistics in Centurion | Madimetsa Logistics`,
  description:
    `Freight transport, warehousing and fleet management serving Johannesburg and the wider Gauteng region, dispatched nationwide from Madimetsa Logistics. Call 072 308 9983.`,
  keywords: [
    'freight transport Centurion',
    'logistics company Centurion',
    'warehousing Centurion',
    'fleet management Gauteng',
    'freight forwarding Centurion',
    'express delivery Centurion',
  ],
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: `Freight & Logistics in Centurion | Madimetsa Logistics`,
    description: `Freight transport, warehousing and fleet management serving Johannesburg, dispatched nationwide. Call 072 308 9983.`,
    url: PAGE_URL,
    type: 'website',
...
const reasons = [
  {
    heading: 'Right on Our Core Route',
    body: `${CITY} sits between our Johannesburg and Pretoria hubs, giving businesses here some of the fastest collection and delivery windows in our network.`,
  },
  {
...
export default function CenturionLogisticsPage() {
  return (
    <>
      <script
      ...
      <section className="relative bg-[#0a0a0a] overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-14 md:py-20">
          ...
          <p className="text-white/60 text-lg md:text-xl leading-relaxed max-w-2xl">
            Madimetsa Logistics dispatches nationwide from our Gauteng hubs, with {CITY}
            sitting right along one of our core collection routes. Freight transport,
