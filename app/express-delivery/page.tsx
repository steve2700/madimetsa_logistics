...
const PAGE_URL = `${BASE_URL}/express-delivery`

export const metadata: Metadata = {
  title: 'Express Delivery South Africa | Same-Day & Next-Day Dispatch | Madimetsa Logistics',
  description:
    'Same-day and next-day express delivery across South Africa. Priority dispatch nationwide from our Gauteng hubs. Call 072 308 9983.',
  keywords: [
    'express delivery South Africa',
    'same-day delivery Gauteng',
    'urgent freight dispatch',
    'next-day delivery South Africa',
    'priority freight Gauteng',
  ],
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: 'Express Delivery South Africa | Madimetsa Logistics',
    description: 'Same-day and next-day dispatch nationwide from our Gauteng hubs. Call 072 308 9983.',
    url: PAGE_URL,
    type: 'website',
...
const serviceSchema = {
  ...
  description: 'Same-day and next-day priority freight dispatch nationwide from Gauteng hubs.',
  url: PAGE_URL,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Express Delivery', item: PAGE_URL },
  ],
}

const included = [
  { title: 'Same-Day Dispatch', body: 'Available on most routes when a shipment cannot wait until the next collection window.' },
  { title: 'Next-Day Delivery', body: 'A reliable option when same-day is not required but urgency still matters.' },
  { title: 'Priority Handling', body: 'Urgent freight is prioritised in scheduling and loading, ahead of standard collections.' },
  { title: 'Fastest Gauteng Turnaround', body: 'Collections from our Gauteng hubs receive the quickest possible dispatch times.' },
  { title: 'Straightforward Quoting', body: 'A clear quote for the fastest available option, no guesswork on urgency pricing.' },
  { title: 'Tracked Throughout', body: 'The same GPS-tracked fleet used on standard routes, so urgent freight stays visible.' },
]

const reasons = [
  { heading: 'Built for Urgency', body: 'When freight cannot wait, our dispatch process is built to prioritise it immediately.' },
  { heading: 'Fastest From Gauteng', body: 'Our Gauteng hubs give us the shortest lead time to collection anywhere in our network.' },
  { heading: 'No Flat Surcharge Guesswork', body: 'Urgent freight is priced on the route and load, and we give you a straightforward quote upfront.' },
  { heading: 'Same Standards, Faster', body: 'Express freight gets the same tracked, careful handling as every other shipment, just faster.' },
]

const process = [
  { step: '01', title: 'Call It In', body: 'Tell us the load and how urgently it needs to move.' },
  { step: '02', title: 'Priority Quote', body: 'We give you a straightforward quote for the fastest available dispatch option.' },
  { step: '03', title: 'Immediate Collection', body: 'Your freight is prioritised for the next available collection slot.' },
  { step: '04', title: 'Delivered Fast', body: 'Tracked throughout, delivered as urgently as the situation requires.' },
]
    ...
    <>
      ...
      <div className="bg-[#f5f4f0] border-b border-[#1a1a1a]/8">
        <div className="max-w-6xl mx-auto px-6">
          <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Services', href: '/services' }, { label: 'Express Delivery' }]} />
        </div>
      </div>
      ...
      <section className="relative bg-[#0a0a0a] overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-14 md:py-20">
          ...
          <p className="text-white/60 text-lg md:text-xl leading-relaxed max-w-2xl">
            When freight needs to move fast, we prioritise it. Same-day and
            next-day dispatch nationwide, with the fastest turnaround on
            collections from our Gauteng hubs.
          </p>
      ...
      <section className="bg-white py-4 md:py-6">
        <div className="max-w-6xl mx-auto px-6">
          <figure className="relative aspect-[21/9] overflow-hidden">
            <Image
              src="/images/route-planning.webp"
              alt="Freight moving fast on an open South African highway"
              fill
            ...
            <figcaption className="absolute bottom-5 left-6 right-6 text-white font-semibold text-sm md:text-base">
              Same-day and next-day dispatch for the moments when waiting is not an option.
            </figcaption>
          </figure>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
            <div className="max-w-xl">
              ...
              <p className="text-white/70 text-base leading-relaxed">
                Call now for a straightforward quote on the fastest available
                dispatch option.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3 shrink-0">
              <a
                href="tel:0723089983"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-[#b91c1c] font-black text-lg hover:bg-[#f5f4f0] transition-colors"
              >
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center px-8 py-4 border border-white/40 text-white font-semibold hover:bg-white hover:text-[#b91c1c] transition-colors"
              >
                Request a Quote
              </Link>
            </div>
