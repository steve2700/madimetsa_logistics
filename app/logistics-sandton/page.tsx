...
const PAGE_URL = `${BASE_URL}/logistics-sandton`

export const metadata: Metadata = {
  title: `Freight & Logistics in Sandton | Madimetsa Logistics`,
  description:
  ...
  keywords: [
    'freight transport Sandton',
    'logistics company Sandton',
    'warehousing Sandton',
    'fleet management Gauteng',
    'freight forwarding Sandton',
    'express delivery Sandton',
  ],
...
const reasons = [
  {
    heading: 'Built for Business Districts',
    body: `${CITY}'s office parks and commercial hubs get the same reliable collection windows as our industrial routes, no freight is too small or too corporate.`,
  },
  {
...
export default function SandtonLogisticsPage() {
  return (
    <>
      <script
      ...
      <section className="relative bg-[#0a0a0a] overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-14 md:py-20">
          ...
          <p className="text-white/60 text-lg md:text-xl leading-relaxed max-w-2xl">
            ...
            routes serving {CITY}'s business and commercial districts. Freight
            transport, warehousing and fleet management, handled by one dependable partner.
          </p>
          <div className="mt-8">
            <a
              href="tel:0723089983"
