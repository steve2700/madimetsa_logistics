...
const CITY = 'Durban'
const PROVINCE = 'KwaZulu-Natal'
const BASE_URL = 'https://www.madimetsalogistics.co.za'
const PAGE_URL = `${BASE_URL}/logistics-durban`

export const metadata: Metadata = {
  title: `Freight & Logistics in Durban | Madimetsa Logistics`,
  description:
    `Freight transport, warehousing and fleet management serving Durban and the wider KwaZulu-Natal region, dispatched nationwide from Madimetsa Logistics. Call 072 308 9983.`,
  keywords: [
    'freight transport Durban',
    'logistics company Durban',
    'warehousing Durban',
    'fleet management KwaZulu-Natal',
    'freight forwarding Durban',
    'express delivery Durban',
  ],
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: `Freight & Logistics in Durban | Madimetsa Logistics`,
    description: `Freight transport, warehousing and fleet management serving Durban, dispatched nationwide. Call 072 308 9983.`,
    url: PAGE_URL,
    type: 'website',
...
export default function DurbanLogisticsPage() {
  return (
    <>
      <script
