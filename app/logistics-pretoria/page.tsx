...
const PAGE_URL = `${BASE_URL}/logistics-pretoria`

export const metadata: Metadata = {
  title: `Freight & Logistics in Pretoria | Madimetsa Logistics`,
  description:
  ...
  keywords: [
    ...
    'logistics company Pretoria',
    'warehousing Pretoria',
    'fleet management Gauteng',
    'freight forwarding Pretoria',
    'express delivery Pretoria',
  ],
...
const reasons = [
  {
    heading: 'Direct Route From Our Gauteng Hubs',
    body: `${CITY} sits on one of our core Gauteng routes, so collections and deliveries here run on tight, predictable turnaround times.`,
  },
  {
...
export default function PretoriaLogisticsPage() {
  return (
    <>
      <script
      ...
      <section className="relative bg-[#0a0a0a] overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-14 md:py-20">
          ...
          <p className="text-white/60 text-lg md:text-xl leading-relaxed max-w-2xl">
            ...
            routes serving {CITY} and the greater Tshwane metro. Freight transport,
