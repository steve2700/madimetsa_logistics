...
const PAGE_URL = `${BASE_URL}/logistics-johannesburg`

export const metadata: Metadata = {
  title: `Freight & Logistics in Johannesburg | Madimetsa Logistics`,
  description:
  ...
  keywords: [
    ...
    'freight forwarding Johannesburg',
    'express delivery Johannesburg',
  ],
...
const reasons = [
  {
    heading: 'Local Hub, Fastest Turnaround',
    body: `${CITY} sits at the centre of our Gauteng network, so collections and deliveries here get our fastest dispatch times.`,
  },
  {
...
export default function JohannesburgLogisticsPage() {
  return (
    <>
      <script
      ...
      <section className="relative bg-[#0a0a0a] overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-14 md:py-20">
          ...
          <p className="text-white/60 text-lg md:text-xl leading-relaxed max-w-2xl">
            Madimetsa Logistics is based in {PROVINCE}, with {CITY} at the heart of our
            dispatch network. Freight transport, warehousing and fleet management,
            handled by one dependable partner.
          </p>
          <div className="mt-8">
            <a
              href="tel:0723089983"
