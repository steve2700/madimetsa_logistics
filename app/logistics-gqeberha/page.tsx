...
const PAGE_URL = `${BASE_URL}/logistics-gqeberha`

export const metadata: Metadata = {
  title: `Freight & Logistics in Gqeberha | Madimetsa Logistics`,
  description:
  ...
  keywords: [
    'freight transport Gqeberha',
    'logistics company Port Elizabeth',
    'warehousing Eastern Cape',
    'fleet management Eastern Cape',
    'freight forwarding Gqeberha',
    'express delivery Port Elizabeth',
  ],
...
const reasons = [
  {
    heading: 'Regular Eastern Cape Routes',
    body: `We run scheduled routes between our Gauteng hubs and ${CITY}, so freight to and from the Eastern Cape moves on a dependable timetable, not on an ad hoc basis.`,
  },
  {
...
export default function GqeberhaLogisticsPage() {
  return (
    <>
      <script
